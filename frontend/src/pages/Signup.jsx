...
import { UserPlus, ShieldCheck, Key, User } from "lucide-react";
...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 antialiased bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-pink-100/20 blur-[120px] rounded-full -translate-y-1/2 -translate-x-1/2"></div>
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-pink-100/10 blur-[120px] rounded-full translate-y-1/2 translate-x-1/2"></div>
        ...
        <div className="w-full md:w-7/12 p-16 bg-white/50 backdrop-blur-md flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="space-y-8">
              ...
              >
                <UserPlus size={16} /> Initialize Profile
              </motion.button>
            </div>

            <p className="mt-16 text-center text-[10px] font-black text-gray-400 uppercase tracking-widest">
              Existing operative? <Link to="/" className="text-pink-600 font-black hover:underline italic ml-1">Authenticate Here</Link>
            </p>
          </div>
        </div>
